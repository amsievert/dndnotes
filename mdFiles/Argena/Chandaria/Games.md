ames are a popular pastime for all manner of folk across [[Chandaria]]. Games are played in taverns, castle keeps, and hovels alike throughout the land. The popularity of games has also led to the rise of gambling. Gambling often happens in taverns, but it can also happen in more private areas too. Gambling however, is not legal across all of [[Chandaria]], with areas such as [[Luminespore Hollow]] in the [Larenthian Alliance](The%20Larenthian%20Alliance.md), and [[Marrisburg]] in [Falstor](Falstor%20(Kingdom).md) outlawing gambling.
## Common Games
...
##### Shooting
The player with the ball can attempt to throw it into the goal. To do so they make a ranged attack roll. This roll is contested by the goalie making an acrobatics check. If the attack roll beats the goalie's acrobatics check, the ball goes in. If the goalie beats the attack roll by more than 5, they catch it. If not, the ball rebounds back into play at a random point around the goal arc. If a goalie is forced to make multiple saves in a turn, all subsequent rolls after the first are done with disadvantage.
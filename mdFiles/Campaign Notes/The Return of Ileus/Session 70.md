...
Aimar fought in the Seldo-Olympian war in the Battle of the Silvermouth towards the end of the war.
##### Aquallor Encounters
When travelling on Aimar's ship, a long rest can only be taken when docked on land.

Sailing to Null Island takes two weeks.

One night, Aimar remarks that Naivara the resurgent goddess has graced the ship with her presence. The full moon hangs in the sky, brighter and larger than ever seen on the Material Plane. The ship lurches as Aimar fights the shifting tides for a moment before getting the ship back under control. Later in the night, Aimar points out that they are going to have to stop for a few hours because the tide will get very low. When this happens, the sea life retreats to small chasms in the ground where water remains. This also reveals a shipwreck almost entirely submerged in the sea floor. Aimar goes to check it out. After some digging, a piece of the ship gets uncovered that has an insignia of a rearing Wyvern. Astarius can recognize this without a check as the insignia of the old [[Dalonstor#The Houses of Dalonstor|House Wymar from Dalonstor]]. The ship itself has skeletons in it of dead sailors. The ship is also rotated so that the bow is pointed straight up. If climbed all the down, at the back (bottom) of the ship is a large vault. The vault is surprisingly unrusted, as it is made of adamantine. The vault has a combination lock with five numbers, each between 0-99. In the captains quarters is the body of the captain, who has the combination to the vault inside his trifold hat. The combination is 20-37-07-12-57. Inside the vault is a treasure hoard containing 7,500 gp worth of art items (Painting of Dalonstor from atop King's Steps, Embroidered Silk Mantle set with moonstones, Gold circlet in the shape of the Wymar wyvern with four aquamarines in it), and 10,000 silver pieces. There is also an Ersatz Finger that acts as a mystery key (5% chance to unlock a lock that it is stuck in).
...
One night, Aimar is laying on top of the canopy over the captain's deck. He invites the party to lay with him. The night sky is lit up with a massive meteor shower. He explains that sometimes during a new moon, Naivara's soul returns to the depths of the Astral plane and her power alights the other stars and causes them to streak across the night sky. This is a common story, but in reality, during a new moon, Naivara's protection of the border between the Astral plane and the other planes grows thinnest, and aberrations from the Astral plane attempt to invade the other planes, which is what the shooting stars actually are. A DC 18 perception check sees the small outline of a dragon following one of the shooting stars that seems extra close to the ground. This star streaks perpendicular to the direction to hourglass isle.

A few days later, the party notices that a small island that they passed a while ago has stayed the same distance from the ship for a while, and is now slowly getting closer to them. The island is the back of a dragon turtle that is specialized for Aquallor, with a very fast burrowing speed to dig through the ocean floor. If the dragon turtle catches the ship, it surfaces and attempts to talk to the party. The dragon is named Ontigistes, and can smell the presence of Knoglir on the party. Ontigistes is suspicious of the party, since Knoglir and her used to know each other long ago during the Age of Dragons. Ontigistes questions the party of if they about Knoglir's true backstory. 
